  ...
  >
    <div className="flex justify-between items-start mb-6">
      ...
      <div className="flex gap-4">
        {project.links.repo && (
          <a href={project.links.repo} className="text-slate-400 hover:text-cyan-300 transition-colors">
            <Github size={20} />
          </a>
        )}
        {project.links.demo && (
          <a href={project.links.demo} className="text-slate-400 hover:text-cyan-300 transition-colors">
